  ...
  const features = [
    {
      ...
      title: 'Дашборд',
      description: 'Общая статистика, графики доходов и расходов, последние транзакции.',
    },
    {
      icon: <Payment sx={{ color: '#2e7d32' }} />,
      title: 'Транзакции',
      description: 'Создавайте, редактируйте и удаляйте платежные операции. Фильтруйте по типу, статусу и категориям.',
    },
    {
      icon: <BarChart sx={{ color: '#ed6c02' }} />,
      title: 'Аналитика',
      description: 'Детальная аналитика с графиками по месяцам, категориям и трендам расходов.',
    },
    {
      icon: <Category sx={{ color: '#9c27b0' }} />,
      title: 'Категории',
      description: 'Управляйте категориями платежей. Создавайте свои категории с уникальными цветами.',
    },
    {
      icon: <AdminPanelSettings sx={{ color: '#d32f2f' }} />,
      title: 'Администрирование',
      description: 'Управление пользователями, статистика системы (только для администраторов).',
    },
  ];

  const quickTips = [
    '💡 Используйте фильтры для быстрого поиска транзакций',
    '📊 Графики обновляются автоматически при добавлении данных',
    '🎨 Цвета категорий помогают визуально различать типы расходов',
